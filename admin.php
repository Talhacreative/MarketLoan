...
function myfun(){
    ...
    <form action="admininsert.php" method="POST" enctype="multipart/form-data" onsubmit="return myfun()" style="margin-top:25px;"> 
    <section class="intro">
        ...
        <div class="inner" >
            ...
            <div class="content" style="background-color:blue">
             ...
             <img src="image/admin.jpg" alt="" style="border-radius:30px; height:200px"><br><br>

             <input type="text" placeholder="name" class="input" id="name" name="name" style="border-radius:30px;"><br>
             <span id="message"></span><br>

            

             <input type="password" placeholder="Password" class="input" id="password" name="password" style="border-radius:30px;"><br>
             <span id="message1"></span><br><br><br><br>

             

              
            
             <a href="http://localhost/6mid/adminpanel.php">  <input type="submit" class="btn" name="submit" value="Submit" style="border-radius:50px; width:150px; height:50px"> <br></a>
...
<a href="http://localhost/6mid/adminpanel.php">  <input type="submit" class="btn" name="submit" value="Main" style="border-radius:50px; width:150px; height:50px; margin-top:20px"> <br></a>
