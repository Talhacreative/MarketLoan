...
$name=$_POST['name'];
 ...
 $up="UPDATE user set name= '$name',password='$password' WHERE cnic='".$_POST['cnic']."'";
    ...
    <section class="intro">
        ...
        <div class="inner" >
            ...
            <div class="content" style="background-color:lightblue">
             ...
             <input type="hidden"  placeholder="id"  id="id" name="id"  style="border-radius:30px;" value="<?php echo $row['cnic']; ?>
" ><br>
             <span id="message2"></span><br><br>

             <input type="text" placeholder="Username" class="input" id="name" name="name" style="border-radius:30px;"  value="<?php echo $row['name']; ?>
"><br>
...
"  ><br>
             ...
             <a href="http://localhost/5th%20sem%20project/screen%20divider.php">  <input type="submit" class="btn" name="submit" value="submit" style="border-radius:50px; width:150px; height:50px ;  background-color: rgb(28, 58, 97); font-size:20px"> <br></a>
    ...
    <a href="http://localhost/5th%20sem%20project/welcome.php">  <input type="submit" class="btn" name="submit" value="Previous Page" style="border-radius:50px; width:150px; height:50px"> <br></a>
</body>
</html>